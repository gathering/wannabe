...
<html lang="en">
	...
	<body>
		<header>
			<a href="/<?=$wannabe->event->reference?>/"><img src="/img/wtextlogo-<?=$wannabe->lang?>.png" alt="<?=__("Wannabe – The event database")?>"/></a>
		</header>

		<div id="modal" class="modal hide fade in generic-long">
<?php
if(isset($form)):
...
?>
			<div class="modal-header">
				<a href="/<?=$wannabe->event->reference?>/" class="close">×</a>
				<h3><?php echo $title_for_layout?> <small><?php echo $desc_for_layout?></small></h3>
			</div>
...
<?php endif; ?>
		...
		<footer>
			<a href="/<?=$wannabe->event->reference?>/"><img src="/img/wlogo.png" alt="W" /></a>
			<div id="debugInfo">
