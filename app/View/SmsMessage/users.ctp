<form method="post">
<fieldset>
    <legend><?=__("Send SMS to user ids, comma separated")?></legend>
    <div class="clearfix">
        <label for="[SmsMessage][users]"><?=__("User ids")?></label>
        <div class="input">
            <?=$this->Form->textfield('SmsMessage.users', array('class' => 'span8'))?>
        </div>
    </div>
    <div class="clearfix">
