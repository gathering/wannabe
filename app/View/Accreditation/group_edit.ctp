...
<div class="row">
    ...
    <? } else { ?>
        <div><a href="<?=$this->Wb->eventUrl("/Accreditation/GroupCheckin/{$group_id}/{$accreditation['Accreditation']['id']}")?>" class="btn primary"><?=__("Checkin")?></a></div>
    <? } ?>
    </div>
...
<? //Checkout ?>
    ...
    <?php if($has_arrived && !$has_departed) { ?>
        <div><a href="<?=$this->Wb->eventUrl("/Accreditation/GroupCheckout/{$group_id}/{$accreditation['Accreditation']['id']}")?>" class="btn primary"><?=__("Checkout")?></a> </div>
    <? } elseif(!$has_arrived) { ?>
...
<? //Reset checkin/out data ?>
    <div class="span6">
        ...
        <div><a href="<?=$this->Wb->eventUrl("/Accreditation/GroupResetCheckinOut/{$group_id}/{$accreditation['Accreditation']['id']}")?>" class="btn danger"><?=__("Reset")?></a> </div>
    </div>
</div>
...
<div class="row">
    <div class="span16">
        <form method="post" action="<?=$this->Wb->eventUrl("/Accreditation/GroupEdit/{$group_id}/{$accreditation['Accreditation']['id']}/saveaccreditation")?>">
            <fieldset>
