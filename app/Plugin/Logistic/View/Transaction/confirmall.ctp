...
<?php if($transaction['LogisticTransaction']['logistic_status_id'] == 4) { ?>
    <h3><?=__("This will result in all copies being checked out to the same person, are you sure of this?")?></h3>
<?php } ?>
<dl>
    ...
    <?php if(isset($transaction['LogisticTransaction']['logistic_storage_id'])) { ?>
        <dt><?=__("Place")?></dt><dd><?=$storagelist[$transaction['LogisticTransaction']['logistic_storage_id']]?></dd>
    <?php } ?>
</dl>
