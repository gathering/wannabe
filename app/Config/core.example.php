 ...
 */
	Configure::write('Exception', array(
		...
		'renderer' => 'WannabeExceptionRenderer',
		'log' => true
	));
 ...
 *
 */
//Configure::write('Routing.prefixes', array('q'));
 ...
 */
	Configure::write('Session', array(
        ...
        'timeout' => '6048',
        'ini' => array(
            'session.cookie_domain' => '.wannabe.gathering.org'
        )
	));
 ...
 */
	Configure::write('Acl.classname', 'WannabeACLSystem');
